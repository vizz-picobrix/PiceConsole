...
function mark_reactions(signal, status, schedule_async = true) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    var should_schedule = (flags2 & DIRTY) === 0 && (schedule_async || (flags2 & ASYNC) === 0);
    if (should_schedule) {
...
var _previous, _callbacks, _pending, _deferred, _neutered, _async_effects, _boundary_async_effects, _render_effects, _effects, _block_effects, _Batch_instances, traverse_effect_tree_fn, commit_fn;
...
//# sourceMappingURL=chunk-7ZWGUBRS.js.map
